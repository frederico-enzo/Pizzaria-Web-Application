...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<String> create(@RequestBody final ItemDTO DTO) {
        try {
    ...
    public ResponseEntity<String> update(@RequestParam("id") final Long id, @RequestBody final ItemDTO DTO){
        try {
